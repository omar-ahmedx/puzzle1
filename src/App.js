  ...
  const check = () => {
    ...
    for (let i = 0; i < checkboxArray.length; i++) {
      if (checkboxArray[i].checked === true) {
        if (checkboxArray[i].name === "_0" || checkboxArray[i].name === "_6") {
          correct += 1;
        }
      }
    }
    ...
    <div>
      <div className="App">
        ...
        <div className="main-container">
          ...
          <div>
            <h1>هل بامكانك اثبات براءة علي يوسف جميل </h1>
            <h2>
              ماهما المستندان اللذان يزيلان تهمة قتل غادة ماسي عن ابو جميل
              <br />
              اثبت ذلك أدناه للانتقال إلى الجزء التالي من القضية
            </h2>
